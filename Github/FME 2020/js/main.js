...
"NodeList" in window && !NodeList.prototype.forEach && (console.info("polyfill for IE11"), NodeList.prototype.forEach = function(o, i) {
    i = i || window;
    for (var t = 0; t < this.length; t++) o.call(i, this[t], t, this)
});
! function(e, t) {
    ...
    var v = function(e, t) {
        ...
        var T = Object.create(v.prototype),
            ...
            r = null,
            i = window.cancelAnimationFrame || window.mozCancelAnimationFrame || clearTimeout,
        ...
        if (T.elems = a, T.options.wrapper && !T.options.wrapper.nodeType) {
            var s = document.querySelector(T.options.wrapper);
            if (!s) throw new Error("The wrapper you're trying to use don't exist.");
            T.options.wrapper = s
        }
        var m = function() {
                for (var e = 0; e < d.length; e++) T.elems[e].style.cssText = d[e].style;
                d = [], z = window.innerHeight, A = window.innerWidth, f(),
                    function() {
                        for (var e = 0; e < T.elems.length; e++) {
                            var t = u(T.elems[e]);
                            d.push(t)
                        }
                    }(), h(), o && (window.addEventListener("resize", m), o = !1, w()), h()
            },
            u = function(e) {
                var t = e.getAttribute("data-rellax-percentage"),
                    o = e.getAttribute("data-rellax-speed"),
                    n = e.getAttribute("data-rellax-zindex") || 0,
                    r = e.getAttribute("data-rellax-min"),
                    i = e.getAttribute("data-rellax-max"),
                    a = T.options.wrapper ? T.options.wrapper.scrollTop : window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop;
                T.options.relativeToWrapper && (a = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop) - T.options.wrapper.offsetTop);
                var s = T.options.vertical && (t || T.options.center) ? a : 0,
                    l = T.options.horizontal && (t || T.options.center) ? window.pageXOffset || document.documentElement.scrollLeft || document.body.scrollLeft : 0,
                    p = s + e.getBoundingClientRect().top,
                    d = e.clientHeight || e.offsetHeight || e.scrollHeight,
                    c = l + e.getBoundingClientRect().left,
                    m = e.clientWidth || e.offsetWidth || e.scrollWidth,
                    u = t || (s - p + z) / (d + z),
                    f = t || (l - c + A) / (m + A);
                T.options.center && (u = f = .5);
                var w = o || T.options.speed,
                    h = E(f, u, w),
                    v = e.style.cssText,
                    y = "";
                if (0 <= v.indexOf("transform")) {
                    var g = v.indexOf("transform"),
                        x = v.slice(g),
                        b = x.indexOf(";");
                    y = b ? " " + x.slice(11, b).replace(/\s/g, "") : " " + x.slice(11).replace(/\s/g, "")
                }
                return {
                    baseX: h.x,
                    baseY: h.y,
            ...
            f = function() {
                var e = l,
                    t = p;
                if (l = T.options.wrapper ? T.options.wrapper.scrollTop : (document.documentElement || document.body.parentNode || document.body).scrollTop || window.pageYOffset, p = T.options.wrapper ? T.options.wrapper.scrollLeft : (document.documentElement || document.body.parentNode || document.body).scrollLeft || window.pageXOffset, T.options.relativeToWrapper) {
                    var o = (document.documentElement || document.body.parentNode || document.body).scrollTop || window.pageYOffset;
                    l = o - T.options.wrapper.offsetTop
                }
                return !(e == l || !T.options.vertical) || !(t == p || !T.options.horizontal)
            },
            E = function(e, t, o) {
                var n = {},
                    r = o * (100 * (1 - e)),
                    i = o * (100 * (1 - t));
                return n.x = T.options.round ? Math.round(r) : Math.round(100 * r) / 100, n.y = T.options.round ? Math.round(i) : Math.round(100 * i) / 100, n
            },
            w = function() {
                f() && !1 === o && h(), r = n(w)
            },
            h = function() {
                for (var e, t = 0; t < T.elems.length; t++) {
                    var o = (l - d[t].top + z) / (d[t].height + z),
                        n = (p - d[t].left + A) / (d[t].width + A),
                        r = (e = E(n, o, d[t].speed)).y - d[t].baseY,
                        i = e.x - d[t].baseX;
                    null !== d[t].min && (T.options.vertical && !T.options.horizontal && (r = r <= d[t].min ? d[t].min : r), T.options.horizontal && !T.options.vertical && (i = i <= d[t].min ? d[t].min : i)), null !== d[t].max && (T.options.vertical && !T.options.horizontal && (r = r >= d[t].max ? d[t].max : r), T.options.horizontal && !T.options.vertical && (i = i >= d[t].max ? d[t].max : i));
                    var a = d[t].zindex,
                        s = "translate3d(" + (T.options.horizontal ? i : "0") + "px," + (T.options.vertical ? r : "0") + "px," + a + "px) " + d[t].transform;
                    T.elems[t].style[c] = s
                }
                T.options.callback(e)
            };
        return T.destroy = function() {
            for (var e = 0; e < T.elems.length; e++) T.elems[e].style.cssText = d[e].style;
            o || (window.removeEventListener("resize", m), o = !0), i(r), r = null
        }, m(), w(), T.refresh = m, T
    };
    return v
});
(function() {
    ...
    function addEvent(type, fn, arg) {
        window.addEventListener(type, fn, arg || !1)
    }

    function removeEvent(type, fn, arg) {
        window.removeEventListener(type, fn, arg || !1)
    }
...
window.addEventListener("load", function() {
    ...
    removeParallaxClass()
    addEventListener("resize", removeParallaxClass, !1)
    ...
    reAddParallaxClass()
    addEventListener("resize", reAddParallaxClass, !1)
    var bodyClass = document.getElementsByClassName("bodyclass")[0]
    var homePage = document.getElementsByClassName("home")[0],
        workPage = document.getElementsByClassName("work")[0],
        processPage = document.getElementsByClassName("process")[0],
        contactPage = document.getElementsByClassName("contact")[0];
    var easeNone = Linear.easeNone,
        customEase = CustomEase.create("custom", "M0,0 C0.022,0.068 0.06,0.266 0.126,0.46 0.184,0.631 0.278,0.754 0.36,0.832 0.448,0.916 0.563,0.96 0.678,0.978 0.81,0.998 0.902,1 1,1"),
        easeInOut = Power1.easeInOut;
    if (bodyClass && !homePage) {
        var pageFadeIn = new TimelineMax();
        pageFadeIn.to(bodyClass, .75, {
            opacity: 1,
            ease: Power1.easeIn
        })
    }
    if (homePage) {
        var pageFadeIn = new TimelineMax();
        pageFadeIn.to(bodyClass, .01, {
            opacity: 1
        })
    }
    TweenMax.from(".js-intro-stagger", 1, {
        opacity: 0,
        y: 10,
        ease: customEase
    })
    ...
    var menuButton = document.getElementsByClassName('menu-button')[0],
        bar1 = document.getElementsByClassName('bar-1')[0],
        bar2 = document.getElementsByClassName('bar-2')[0],
        bar3 = document.getElementsByClassName('bar-3')[0],
        bar4 = document.getElementsByClassName('bar-4')[0],
        menuWordMenu = document.getElementsByClassName('menu-word-menu')[0],
        menuWordClose = document.getElementsByClassName('menu-word-close')[0],
        navMenuItems = document.getElementsByClassName('nav-menu-items')[0]
    var menuClicked = !1

    function menuButtonAnimation() {
        if (menuClicked === !1) {
            setTimeout(function() {
                bodyClass.classList.add('fixed')
            }, 350)
            menuWordMenu.classList.remove('reset')
            menuWordMenu.classList.add('active')
            menuWordClose.classList.remove('reset')
            menuWordClose.classList.add('active')
            bar1.classList.remove('reset')
            bar1.classList.add('active')
            bar2.classList.remove('reset')
            bar2.classList.add('active')
            bar3.classList.remove('reset')
            bar3.classList.add('active')
            bar4.classList.remove('reset')
            bar4.classList.add('active')
            navMenuItems.classList.add('display')
            navMenuItems.classList.remove('reset')
            navMenuItems.classList.add('active')
            menuClicked = !0
        } else {
            menuWordMenu.classList.add('reset')
            menuWordMenu.classList.remove('active')
            menuWordClose.classList.remove('active')
            menuWordClose.classList.add('reset')
            bar1.classList.remove('active')
            bar1.classList.add('reset')
            bar2.classList.remove('active')
            bar2.classList.add('reset')
            bar3.classList.remove('active')
            bar3.classList.add('reset')
            bar4.classList.remove('active')
            bar4.classList.add('reset')
            navMenuItems.classList.remove('active')
            navMenuItems.classList.add('reset')
            setTimeout(function() {
                bodyClass.classList.remove('fixed')
            }, 350)
            menuClicked = !1
        }
    }
    menuButton.addEventListener('click', menuButtonAnimation, !1)

    function setMobileMenuDefaults() {
        if (window.innerWidth > 900) {
            ...
            navMenuItems.classList.remove('active')
            navMenuItems.classList.remove('reset')
            navMenuItems.classList.remove('display')
        }
    }
    addEventListener('resize', setMobileMenuDefaults, !1)
    var controller = new ScrollMagic.Controller();
    var homeImage = document.getElementsByClassName("home-image")[0],
        imageCoverHome = document.getElementsByClassName("js-image-cover-home")[0],
        loadReveal = document.getElementsByClassName("load-reveal")
    var boxCoverHomeTl = new TimelineMax().timeScale(1)
    if (homePage) {
        boxCoverHomeTl.set('.main-left-line', {
            scaleY: 0
        }).set(".heading-image-small-box", {
            scaleX: 0,
            ...
            scaleX: 0
        }).add("start").to('.heading-image-small-box', .75, {
            scaleX: 1,
            ease: customEase
        }).to('.main-left-line', .75, {
            scaleY: 1,
            transformOrigin: "0 0",
            ease: customEase
        }, "start").to(imageCoverHome, .75, {
            scaleX: 1,
            ease: customEase
        }, "start").add("secondStage").to(homeImage, 0, {
            opacity: 1
        }, "secondStage").to(imageCoverHome, .75, {
            scaleX: 0,
            ease: customEase,
            transformOrigin: "left"
        }, "secondStage").staggerFrom(loadReveal, 1.5, {
            opacity: 0,
            y: 30,
            ease: customEase,
            rotation: .01
    ...
    tlGlitch.to("#home-image-2", .01, {
        opacity: 1
    }).to("#theClipPath-2 rect", .7, {
        x: 0,
        y: "-60%"
    }).to("#theClipPath-2 rect", .5, {
        x: 0,
        y: "5%"
    }).to("#home-image-2", .1, {
        opacity: 0
    }, "-=.3").to("#home-image-3", .01, {
        opacity: 1
    }).to("#theClipPath-3 rect", .4, {
        x: 0,
        yPercent: -300
    }).to("#theClipPath-3 rect", .1, {
        x: 0,
        yPercent: -400
    }).to("#home-image-3", .1, {
        opacity: 0
        ...
        opacity: 1
    }).to("#theClipPath-4 rect", .4, {
        x: 0,
        yPercent: -300
    }).to("#theClipPath-4 rect", .1, {
        x: 0,
        yPercent: -400
    }).to("#home-image-4", .1, {
        opacity: 0
    ...
    var emailButton = document.querySelector('.email-button'),
        emailUs = document.querySelector('.email-us');
    var showEmailButton = new TimelineMax();
    showEmailButton.to([emailButton, emailUs], .01, {
        display: "flex"
    }).to([emailButton, emailUs], .75, {
        opacity: 1
    });
    var hideEmailButton = new TimelineMax()
    hideEmailButton.to([emailButton, emailUs], .1, {
        opacity: 0
    }).to([emailButton, emailUs], .01, {
        display: "none"
    })
    var showEmailButton_ScrollTrigger = new ScrollMagic.Scene({
        triggerElement: homePage ? ".section-2" : ".section-2",
        triggerHook: homePage ? ".1" : ".9"
    }).setTween(showEmailButton).addTo(controller);
    var hideEmailButton_ScrollTrigger = new ScrollMagic.Scene({
        triggerElement: homePage ? ".footer" : ".footer",
        triggerHook: '.99',
        offset: "-200px"
    }).setTween(hideEmailButton).addTo(controller);
    TweenMax.set(".work-masker", {
        scaleX: 0,
        transformOrigin: "left center"
    });
    TweenMax.set(".svg-underline-work", {
        scaleX: 0,
        transformOrigin: "left"
    })

    function seeWorkClip() {
        var tl = new TimelineMax();
        tl.add("start").to(".work-masker", 2.8, {
            scaleX: 1,
            ease: customEase
        }).to(".svg-underline-work", 2.8, {
            scaleX: 1,
            ease: customEase
        }, "start")
        return tl
    }
    var seeWork_ScrollTrigger = new ScrollMagic.Scene({
        triggerElement: ".row-3",
        triggerHook: .9,
    }).setTween(seeWorkClip).addTo(controller);
    TweenMax.set(".git-masker", {
        scaleX: 0,
        transformOrigin: "left center"
    });
    TweenMax.set(".svg-underline", {
        scaleX: 0,
        transformOrigin: "left"
    })

    function bottomEmailClip() {
        var tl = new TimelineMax();
        tl.add("start").to(".git-masker", 2.8, {
            scaleX: 1,
            ease: customEase
        }).to(".svg-underline", 2.5, {
            scaleX: 1,
            ease: customEase
        }, "start")
        return tl
    ...
    var showEmailButton_ScrollTrigger = new ScrollMagic.Scene({
        triggerElement: homePage ? ".row-6" : ".row-4",
        triggerHook: .9,
    }).setTween(bottomEmailClip).addTo(controller);
    var workPageSVGUnderline = document.querySelector(".work .svg-underline"),
        homePageSVGUnderlineBottom = document.querySelector(".home .svg-underline"),
        homePageSVGUnderlineUpper = document.querySelector(".home .svg-underline-work")

    function svgUnderlineHomepageTop() {
        if (window.innerWidth > 1799) {
            if (ff && homePageSVGUnderlineUpper) {
                homePageSVGUnderlineUpper.style.cssText = "left: 6.05rem; width: 2.9rem; bottom: 0.7rem; transform-origin: left"
            }
        }
        if (window.innerWidth < 1800 && window.innerWidth > 736) {
            if (ff && homePageSVGUnderlineUpper) {
                homePageSVGUnderlineUpper.style.cssText = "left: 6.15rem; width: 2.85rem; bottom: 0.7rem; transform-origin: left"
            }
        }
        if (window.innerWidth < 737) {
            if (ff && homePageSVGUnderlineUpper) {
                homePageSVGUnderlineUpper.style.cssText = "left: 6.25rem; width: 2.8rem; bottom: 0.8rem; transform-origin: left"
            }
        }
    }
    svgUnderlineHomepageTop()
    window.addEventListener("resize", svgUnderlineHomepageTop, !1)

    function svgUnderlineWorkPage() {
        if (window.innerWidth > 1799) {
            if (ff && workPageSVGUnderline) {
                workPageSVGUnderline.style.cssText = "left: .85rem; width: 7.35rem; transform-origin: left"
            }
        }
        if (window.innerWidth < 1800 && window.innerWidth > 736) {
            if (ff && workPageSVGUnderline) {
        ...
        if (window.innerWidth < 737) {
            if (ff && workPageSVGUnderline) {
                workPageSVGUnderline.style.cssText = "left: .95rem; width: 7.35rem; transform-origin: left"
            }
        }
    }
    svgUnderlineWorkPage()
    window.addEventListener("resize", svgUnderlineWorkPage, !1)

    function homePageSVGUnderlineBottomCorrection() {
        if (window.innerWidth > 1799) {
            if (ff && homePageSVGUnderlineBottom) {
                homePageSVGUnderlineBottom.style.cssText = "left: 0.95rem;; width: 6.7rem; transform-origin: left"
            }
        }
        if (window.innerWidth < 1800 && window.innerWidth > 736) {
            if (ff && homePageSVGUnderlineBottom) {
                homePageSVGUnderlineBottom.style.cssText = "left: .95rem; width: 6.75rem; transform-origin: left"
            }
        }
        if (window.innerWidth < 737) {
            if (ff && homePageSVGUnderlineBottom) {
                homePageSVGUnderlineBottom.style.cssText = "left: 1.05rem; width: 6.75rem; transform-origin: left"
            }
        }
    }
    homePageSVGUnderlineBottomCorrection()
    window.addEventListener("resize", homePageSVGUnderlineBottomCorrection, !1)
    var textTrigger = document.querySelectorAll(".js-st");
    var imageTrigger = document.querySelectorAll(".js-st");
    var imageTrigger = document.querySelectorAll(".img-below-fold");
    imageTrigger.forEach(function(el) {
        var arr = [el];
        for (i = 0, len = arr.length; i < len; i++) {
            var myImg = arr[i];
            var pictureReveal = new TimelineMax()
            pictureReveal.to(myImg, 0, {
                opacity: 0
            }).to(myImg, 1.5, {
                opacity: 1,
                ease: customEase
            ...
            var scene = new ScrollMagic.Scene({
                ...
                triggerHook: .9,
                reverse: !1
            }).setTween(pictureReveal).addTo(controller)
        }
    });
    TweenMax.staggerFrom(".js-stagger-intro", 1, {
        opacity: 0,
        y: 20,
        ease: customEase
    }, .03)
    var image = document.getElementsByClassName('cc-image')[0];
    var isIE11 = !!(navigator.userAgent.match(/Trident/) && navigator.userAgent.match(/rv[ :]11/));
    var contactBottomSVG = document.querySelector(".contact .s3-wedge-2"),
        webAppImageCol = document.querySelector(".web-app-image-col"),
        webAppImage = document.querySelector(".web-app-image"),
        privacyParagraph = document.querySelector(".privacy")
    if (isIE11) {
        contactBottomSVG.style.cssText = "display; none;"
        webAppImage.style.cssText = "display:none !important;"
        webAppImageCol.style.cssText = "background-image: url('./img/man.jpg');"
        privacyParagraph.style.cssText = "position:relative; top: 3.8rem;"
    }
})
